...
class Pdfs extends Fpdf
{
    ...
    public function setNumber($data, $compa)
    {
        $pdf        = new Pdfs('L', 'mm', array(50, 110));
        $this->data = $data;
...
//Set Row Height
        ...
        for ($i = 0; $i < count($this->data); $i++) {
            ...
            //$nserie   = $this->data[$i]['serie_nro_serie'];
            //var_dump(expression)
            $nserie = isset($this->data[$i]["A"]) ? $this->data[$i]["A"] : null;

            if ($checkbox == true) {
                array_push($pila, $nserie);
        ...
        foreach ($pila as $value) {
            ...
            $pdf->SetFont('Arial', '', 9);
            $value1 = str_replace("582017", "2017", $value);
            $value1 = str_replace("582018", "2018", $value1);

//A set

            $pdf->SetXY(2, 7);
            $pdf->Write(1, '      ' . $this->compa);
            $pdf->Code128(3, 12, $value1, 40, 7);
            $pdf->Write(1, '                                    ' . $this->compa);
            $pdf->Code128(60, 12, $value1, 40, 7);
...
//print column titles
        ...
        $pdf->Output("images/series-" . $name . ".pdf", "F");

        return $ruta = "images/series-" . $name . ".pdf";
