...
// funcion para crear una obra nueva
    ...
    {
        $address = $via . ' ' . $placa . ",+Medellin+Colombia";
        $address = urlencode($address);

        $string  = '';
        $fullurl = "https://maps.googleapis.com/maps/api/geocode/json?address={$address}&key=AIzaSyBvx7-BSVZT03DHYGgIAUS-p5k_TMny62Q";
    ...
    public function geodecodermedellin($via, $placa, $nome, $str)
    {
        $address = $via . '  ' . $nome . ' ' . $placa;
        $address = urlencode($address);
...
// funcion que devuelve el total de obra subida
    ...
    public function adress_medellin($adress)
    {
        //$adress = $adress;
        ...
        return $response = $this->search_adress($via, $placa, $nome, $str);
    ...
    public function search_adress($via, $placa, $nome, $str)
    {
        ...
        $address = $this->geodecodermedellin($via, $placa, $nome, $str);
...
// Transform the point between datums.
        ...
        if ($resul == 0) {
            ...
            $cor = $this->geodecodermedellin($via, $placa, $nome, $str);
